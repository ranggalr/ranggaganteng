        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col mx-4 my-4">
            ...
            <div class="-mx-3 md:flex mb-6">
                ...
                <div class="md:w-1/2 px-3">
                    ...
                    <input
                        class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" :class="form.error('password_confirmation') ? 'border-red-500' : ''"
                        id="grid-password" type="password" v-model="form.password_confirmation" placeholder="******************">
                    <p class="text-red-500 text-xs italic" v-if="form.error('password_confirmation')">{{ form.error('password_confirmation') }}</p>
                    <p class="text-grey-dark text-xs italic" v-else>Type it the same like the other one</p>
                </div>
            </div>
