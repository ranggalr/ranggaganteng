        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 w-full">
            <div
                ...
                <div class="flex justify-between">
                    ...
                    <inertia-link as="button" :href="route('admin.user.create')"
                        class="px-3 py-2 my-auto border-green-500 border text-green-500 rounded transition duration-300 hover:bg-green-700 hover:text-white focus:outline-none">Add User</inertia-link>
                </div>
            </div>
            <div
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        <tr v-for="user in users.data" :key="user.id">
                            ...
                            <td
                                class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                {{ user.roles.map((v) => { return v.name}).join(',') }}</td>
                            <td
                            ...
                            <td
                                ...
                                <inertia-link as="button" :href="route('admin.user.edit', {user: user.id})"
            ...
            <pagination :data="users" activeClass="bg-blue-500" />
        </div>
    </admin-layout>
</template>
