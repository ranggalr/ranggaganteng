    ...
    <admin-layout>
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col mx-4 my-4">
            ...
            <div class="justify-end flex">
                <input type="submit" @click="submitForm" value="Create" class="border border-indigo-500 bg-indigo-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
            </div>
        </div>
    </admin-layout>
</template>
