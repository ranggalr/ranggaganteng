        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 w-full">
            <div
                ...
                <div class="flex justify-between">
                    ...
                    <inertia-link as="button" :href="route('admin.post.create')"
                        class="px-3 py-2 my-auto border-green-500 border text-green-500 rounded transition duration-300 hover:bg-green-700 hover:text-white focus:outline-none">Add post</inertia-link>
                </div>
            </div>
            <div
                    ...
                    <tbody class="bg-white">
                        <tr v-for="post in posts.data" :key="post.id">
                            ...
                            <td
                                ...
                                <inertia-link as="button" :href="route('admin.post.edit', {post: post.id})"
            ...
            <pagination :data="posts" activeClass="bg-blue-500" />
        </div>
    </admin-layout>
</template>
            ...
            deletePost(id)
            {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.$inertia.delete(route('admin.post.delete', {post:id}), {
                            preserveScroll: true,
                            onSuccess: () => {
                                this.$swal(
                                    'Deleted!',
