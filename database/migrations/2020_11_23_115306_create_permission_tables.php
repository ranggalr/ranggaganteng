...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('permissions')->insert([
            ['name' => 'access admin dashboard', 'guard_name' => 'web'],
            ['name' => 'access admin users', 'guard_name' => 'web'],
            ['name' => 'access admin roles', 'guard_name' => 'web'],
            ['name' => 'access admin posts', 'guard_name' => 'web'],
            ['name' => 'access admin categories', 'guard_name' => 'web'],
            ...
            ['name' => 'update posts', 'guard_name' => 'web'],
